...
document.ready(function () {
  ...
  $(".currenciesTable, .exchangeTable").on("scroll", function (e) {
     let isScroll = e.currentTarget.scrollLeft;
     if (isScroll) {
        $(".ListingTable th:nth-child(2), td:nth-child(2)").classList.add("before");
     } else {
        $(".ListingTable th:nth-child(2), td:nth-child(2)").classList.remove("before");
     }
  });
  ...
  document.getElementsByClassName("historical-data").on("scroll", function (e) {
     let isScroll = e.currentTarget.scrollLeft;
     if (isScroll) {
        $(".ListingTable th:nth-child(1), td:nth-child(1)").classList.add("before");
     } else {
        $(".ListingTable th:nth-child(1), td:nth-child(1)").classList.remove("before");
     }
  });
  ...
  document.getElementsByClassName("searchpopupHider").click(function () {
     ...
     document.getElementsByClassName("searchDiv-for-mb").classList.remove("active");
  });
  ...
  //   $(obj.attr("data-tab")).classList.add("active").siblings().classList.remove("active");
  // });

  document.getElementsByClassName("popupRemover").click(function () {
     document.getElementsById("LoginBox").classList.remove("active");
  ...
  let isHighLight = document.getElementsById("HighlightsBox");
